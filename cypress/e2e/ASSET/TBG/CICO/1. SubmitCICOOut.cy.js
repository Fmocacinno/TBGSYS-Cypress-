...
describe('template spec', () => {
  ...
  let sonumb, siteId, SIMNUM, unique, date, custom, baseUrlCICO, company, operator, PIC_A, PIC_A_ID, Email, JenisPekerjaan, baseUrlCICOOut;
  ...
  beforeEach(() => {
    ...
    cy.readFile('cypress/e2e/ASSET/TBG/CICO/DataVariable.json').then((values) => {
      ...
      baseUrlCICOOut = values.baseUrlCICOOut;
