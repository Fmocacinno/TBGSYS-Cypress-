...
describe('template spec', () => {
  ...
  let sonumb, siteId, unique, date, userAM, userLeadAM, userLeadPM, userARO, pass, userPMFO, userInputStip, UserSPKProject, Uservendor, UserRequestSPKApproval, PICVendor, baseUrlVP, baseUrlTBGSYS, login, dashboard, menu1, menu2, menu3, menu4, logout, Vendoridsoil, UservendorDespon, UserRequestSPKProject;
  before(() => {
  ...
  beforeEach(() => {
    ...
    cy.readFile('cypress/e2e/STIP_1/TBG/NEW_BUILD_MACRO/DataVariable.json').then((values) => {
      ...
      Vendoridsoil = values.Vendoridsoil;
      pass = values.pass;
  ...
  it('Material ON Site Approval PM FO', () => {
    ...
    cy.get('#tbUserID').type(Vendoridsoil);
